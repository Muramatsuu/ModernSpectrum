// src/lib.rs
/*
 * Core library for ModernSpectrum
 */
...
#[derive(Debug)]
pub struct ModernSpectrumProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ModernSpectrumProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ModernSpectrum processing");
    
    let mut processor = ModernSpectrumProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ModernSpectrumProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ModernSpectrumProcessor::new(false);
